...
## Рабочая версия (новая контрольная точка)

- Дата фиксации: `2026-02-17`
- Рабочий commit для Amvera: `116e714`
- Проверка удалённых веток:
  - `origin/main` -> `116e714`
  - `amvera/master` -> `116e714`
- Назначение: текущая рабочая версия после обновления UX workflow и автосоздания проектов.
