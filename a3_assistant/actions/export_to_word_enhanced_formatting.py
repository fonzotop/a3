...
class Action:
    ...
    _I18N_MESSAGES: Dict[str, Dict[str, str]] = {
        ...
        "zh": {
            "converting": "æ­£å¨è½¬æ¢ä¸º Word ææ¡£...",
            "exported": "Word ææ¡£å¯¼åºå®æ",
            "success": "æåå¯¼åºè³ {filename}",
            "error_no_content": "æ²¡ææ¾å°å¯å¯¼åºçåå®¹ï¼",
            "error_export": "å¯¼åº Word ææ¡£æ¶åºé: {error}",
            "export_failed": "å¯¼åºå¤±è´¥: {error}",
            "figure_prefix": "å¾",
            "references": "åèæç®",
        },
    }
    ...
    class Valves(BaseModel):
        ...
        MERMAID_CAPTION_PREFIX: str = Field(
            default="",
            description="Caption prefix label (e.g., 'Figure' or 'å¾'). Empty = auto-detect based on user language.",
        )
    ...
    def set_document_default_font(self, doc: Document):
        ...
        # Standard format: 22pt (äºå·), bold, centered, 24pt space after
        if "Title" in doc.styles:
            title_style = doc.styles["Title"]
            title_font = title_style.font
            title_font.name = self.valves.FONT_LATIN
            title_font.size = Pt(22)  # äºå·å­ä½
        ...
        # Heading 1: 16pt (ä¸å·), bold, space before 24pt, space after 12pt
        # Heading 2: 15pt (å°ä¸), bold, space before 18pt, space after 6pt
        # Heading 3: 14pt (åå·), bold, space before 12pt, space after 6pt
        # Heading 4-9: 12pt (å°å), bold, gradually reduced spacing
        heading_formats = {
